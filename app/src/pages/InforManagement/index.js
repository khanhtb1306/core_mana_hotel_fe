                ...
                <div className="">
                    <div className=" justify-content-between border border-dashed border-blue-500">
                        <div className="my-2 flex justify-between">
                            ...
                            {openButtonChangePassword && (<button className="pt-2 float-right  bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" onClick={() => {
                            ...
                            {!openButtonChangePassword && (<button className="text h-10 bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" onClick={() => {
