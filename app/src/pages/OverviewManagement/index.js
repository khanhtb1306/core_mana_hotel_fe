...
const OverviewPage = () => {
        ...
        if (selectedValue1 === "1") {
          ...
          if (selectedValue2 === "ngay") {
            const response = await axiosPrivate.get(
              "/overview/report_room_capacity_by_month?date=" +
            ...
            const response = await axiosPrivate.get(
              "/overview/report_room_capacity_with_day_of_week_by_month?date=" +
                month.format("YYYY/MM/DD").toString()
            );
            setViewMonthOrDay("Theo Ngày");
            setViewDayOfWeek("Theo Thứ");
  ...
  const handleBarChartTypeChange = (value) => {
    setSelectedValueBarChart2(value);
  };
  ...
  const [reportRoomCapacityBarChart, setReportRoomCapacityBarChart] =
    useState(null);
  ...
  useEffect(() => {
      ...
      try {
        if (selectedValueBarChart1 === "1") {
          ...
          if (selectedValueBarChart2 === "ngay") {
            const response = await axiosPrivate.get(
              "/overview/report_revenue_each_day_by_month?date=" +
            ...
            setViewByMonthBarChart(
              "THEO THÁNG " + sum.toLocaleString() + " VND"
            );
            setViewMonthOrDayBarChart("Theo Ngày");
            setViewDayOfWeekBarChart("Theo Thứ");
          } else if (selectedValueBarChart2 === "thu") {
            const response = await axiosPrivate.get(
              "/overview/report_revenue_day_of_week_by_month?date=" +
                monthBarChart.format("YYYY/MM/DD").toString()
            );
            setReportRoomCapacityBarChart(response.data.result);
            let sum = 0;
          ...
          if (selectedValueBarChart2 === "ngay") {
            const response = await axiosPrivate.get(
              "/overview/report_revenue_month_by_year?year=" +
                yearBarChart.year()
            );
            setReportRoomCapacityBarChart(response.data.result);
            let sum = 0;
          ...
          const response = await axiosPrivate.get(
            "/overview/report_revenue_by_many_years?startYear=" +
              yearBarChart.year()
          );
          setReportRoomCapacityBarChart(response.data.result);
    ...
    monthBarChart,
    yearBarChart,
    selectedValueBarChart1,
    selectedValueBarChart2,
  ]);
        ...
        datasets: [
          {
            ...
            backgroundColor: generateRandomColors(
              reportRoomCapacityBarChart.data.length
            ).map((color) => `${color}1A`), // Adding alpha for transparency
  ...
  const [
    ...
    setSelectedValueHorizontalBarChartData1,
  ] = useState("1");
  const [monthHorizontalBarChartData, setMonthHorizontalBarChartData] =
    useState(dayjs());
  const [yearHorizontalBarChartData, setYearHorizontalBarChartData] = useState(
    dayjs()
  );
  const [
    reportTopRoomClassHorizontalBarChartData,
    setReportTopRoomClassHorizontalBarChartData,
  ] = useState(null);
  ...
  const handleQuarterTypeChange = (value) => {
    setSelectedQuarterData(value);
  };
        ...
        datasets: [
          {
            ...
            backgroundColor: generateRandomColors(
              reportTopRoomClassHorizontalBarChartData.data.length
            ).map((color) => `${color}1A`), // Adding alpha for transparency
            borderColor: generateRandomColors(
              reportTopRoomClassHorizontalBarChartData.data.length
            ),
              ...
              <div className="w-6/12 flex border-r-2 border-solid border-gray-800 mr-4">
                ...
                >
                  <PieChart
                    percentage={
                      roomCapacityInfo
                        ? !isNaN(roomCapacityInfo.percentageRoomsInUse)
              ...
              <div className="w-6/12 flex mr-4">
                ...
                >
                  <PieChart
                    percentage={
                      roomCapacityInfo
                        ? !isNaN(roomCapacityInfo.percentageEmptyRooms)
          ...
          <div className="bg-white p-4 mr-4 my-4 rounded">
            <div className="flex">
              <div className="w-7/12">
                <p className="text-lg">
                  CÔNG SUẤT SỬ DỤNG PHÒNG {viewByMonth}{" "}
                </p>
              </div>
            ...
            <div>
              <div>
                <ul className="flex chart-type-options">
                  <li
                    onClick={() => handleChartTypeChange("ngay")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedValue2 === "ngay"
                  ...
                  <li
                    onClick={() => handleChartTypeChange("thu")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedValue2 === "thu"
          ...
          <div className="bg-white p-4 mr-4 my-4 rounded">
            ...
            <div>
              <div>
                <ul className="flex chart-type-options">
                  <li
                    onClick={() => handleBarChartTypeChange("ngay")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedValueBarChart2 === "ngay"
                          ? "underline solid blue"
                          : "none",
                    }}
                  >
                  ...
                  <span style={{ margin: "0 10px" }}></span>
                  <li
                    onClick={() => handleBarChartTypeChange("thu")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedValueBarChart2 === "thu"
                          ? "underline solid blue"
                          : "none",
                    }}
                  >
          ...
          <div className="bg-white p-4 mr-4 my-4 rounded">
              ...
              <div className="w-5/12 flex">
                ...
                <div className="w-6/12">
                  <select
                    ...
                    onChange={(event) =>
                      handleHorizontalBarChartDataTypeChange(event)
                    }
                  >
            ...
            <div style={{ width: "auto", height: "500px" }}>
              <div>
                <ul className="flex chart-type-options">
                  <li
                    onClick={() => handleQuarterTypeChange("1")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedQuarterData === "1"
                          ? "underline solid blue"
                          : "none",
                    }}
                  >
                  ...
                  <span style={{ margin: "0 10px" }}></span>
                  <li
                    onClick={() => handleQuarterTypeChange("2")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedQuarterData === "2"
                          ? "underline solid blue"
                          : "none",
                    }}
                  >
                  ...
                  <span style={{ margin: "0 10px" }}></span>
                  <li
                    onClick={() => handleQuarterTypeChange("3")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedQuarterData === "3"
                          ? "underline solid blue"
                          : "none",
                    }}
                  >
                  ...
                  <span style={{ margin: "0 10px" }}></span>
                  <li
                    onClick={() => handleQuarterTypeChange("4")}
                    style={{
                      cursor: "pointer",
                      textDecoration:
                        selectedQuarterData === "4"
                          ? "underline solid blue"
                          : "none",
                    }}
                  >
