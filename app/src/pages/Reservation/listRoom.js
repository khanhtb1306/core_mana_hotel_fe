        ...
        if (floor.roomListWithRDs.length > 0) {
          return (
            <div className="w-full p-2">
              <div className="border-t-2 pt-2-2">
                ...
                <div className="grid grid-cols-4 gap-4">
                  {floor.roomListWithRDs.map((room) => {
                    ...
                    return isUsing ? (
                      <button
                        type="button"
                        className="p-4 rounded-lg border border-green-600 bg-green-200 hover:shadow-lg hover:shadow-green-200"
                      >
                        <div className="flex">
                          ...
                          {isClean ? (
                            <>
                              ...
                              <div>
                                <div className="text-red-500 hover:bg-gray-300 px-1 rounded-full">
                            ...
                            <>
                              ...
                              <div>
                                <div className="text-green-500 hover:bg-gray-300 px-1 rounded-full">
                        ...
                        <p className="text-left mt-4 text-sm bg-gray-200 px-1 rounded w-5/12">
                          1 ngày / 1 ngày
                        </p>
                      </button>
                    ) : (
                      <button
                        type="button"
                        className="p-4 rounded-lg border border-gray-600 bg-white hover:shadow-lg hover:shadow-gray-200"
                      >
                        <div className="flex">
                        ...
                        <div className="text-left py-2 pb-6">
