            ...
            return (
              ...
              >
                ...
                <div className="mt-4 border-t border-black border-dotted">
                  Ngày xuất phiếu: {dayjs(importGoods.importGoods.timeImport).format("DD/MM/YYYY")}
                </div>
                <p>Địa chỉ: </p>
                <div className="mt-4">
                ...
                <div className="text-center text-lg text-right ">
                  <p className="mt-3 ">
                    Tổng :{" "}
...
async function loadGoodsUnit() {
  ...
  return response.data.filter((goodsUnit) => goodsUnit.status === 1 );
}
