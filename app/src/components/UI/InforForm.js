...
function InforForm({ staff, method }) {
    ...
    return (
        <Form method="post" className="bg-white flex flex-row " encType="multipart/form-data">
                ...
                <div className="col-md-12 ">
                    <div className="p-3 py-5">
                        <div className="d-flex justify-content-between align-items-center mb-3">
                            <h4 className="text-left text-lg font-bold"> <i className="bi bi-person-circle me-3"></i>Profile Settings</h4>
                        </div>
                        <input
                            readOnly
                            hidden
                        ...
                        <div className="mt-5 text-center">
                            <button className="btn btn-primary bg-green-500 hover:bg-green-700 text-white py-2 px-4" type="submit">
                                Save Profile
                            </button>
                        </div>
                    </div>
