...
function ReservationForm(props) {
  ...
  const [customer, setCustomer] = useState(reservation.reservation.customer);
      ...
      <div className="px-4 w-full py-2 h-1/6 print:hidden">
        <div className="flex">
          ...
          >
            ...
            <span className="mx-2">{reservation.reservation.totalAdults}</span>
            {" | "}
            <i className="fa-solid fa-child ml-2"></i>
            <span className="mx-2">
              {reservation.reservation.totalChildren}
            </span>
          </button>
              ...
              return status === 1 ? (
                <button
                  ...
                  className={`pl-2 pr-1 py-1 ${
                    room.reservationDetailId === roomActive.reservationDetailId
