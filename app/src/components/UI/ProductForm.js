            ...
            <div className={`${openInfo ? "" : "hidden"}`}>
                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          type="number"
                          name="cost"
                          defaultValue={defautUnit.cost ? defautUnit.cost : ""}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          name="price"
                          defaultValue={
                            defautUnit.price ? defautUnit.price : ""
                          }
                        />
                      </td>
                    </tr>
              ...
              <div className="flex justify-center mt-8 w-full focus:border-b-2 focus:border-green-500 focus:ring-0">
                <Image
                  name="image1"
                  src={
                    product.goods.image ? `data:image/png;base64,${product.goods.image}` : null
                  }
                />
                <Image
                  name="image2"
              ...
              <div>
                ...
                <div className="flex m-2">
                  ...
                  <input
                    ...
                    name="unit"
                    defaultValue={
                      defautUnit.goodsUnitName ? defautUnit.goodsUnitName : ""
                    }
                  />
                </div>
                {units.length > 0 && (
